...
workflow  READS_QC {
    ...
    FASTP ( fastp_input, params.save_trimmed_fail )
    ...
    reads_se_and_paired   = ch_reads_se_and_paired                     // channel: [ val(meta), [ fastq ] ]
