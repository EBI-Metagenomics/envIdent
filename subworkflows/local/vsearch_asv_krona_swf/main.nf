...
workflow VSEARCH_ASV_KRONA {
    ...
    take:
        ...
        asv_counts   // [meta, TSV with asv/count columns] from DADA2_SWF.out.asv_counts
    ...
    main:
        ...
        counts_input = asv_counts
            .join(LCA.out.lca_all, failOnDuplicate: true, failOnMismatch: true)
            .join(LCA.out.lca_top, failOnDuplicate: true, failOnMismatch: true)
